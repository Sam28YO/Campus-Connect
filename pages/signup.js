      ...
      <div className="relative z-10 py-12 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className={`text-xl mb-8 max-w-2xl mx-auto ${theme === "dark" ? "text-gray-300" : "text-indigo-700"}`}>
              Join thousands of students connecting, collaborating, and creating amazing experiences together
            </p>
            ...
            <div className="flex justify-center items-center gap-8 mb-8">
              {[
                ...
                { icon: CheckCircle, label: "Verified Safe", color: "text-green-400" },
              ].map((item, index) => {
                const Icon = item.icon
                return (
                  <div key={index} className="flex items-center gap-2">
                    <Icon className={`w-5 h-5 ${item.color}`} />
                    <span className={`text-sm font-medium ${theme === "dark" ? "text-gray-300" : "text-indigo-700"}`}>
                      {item.label}
                    </span>
                  </div>
                )
          ...
          <div
            className={`backdrop-blur-xl rounded-3xl border shadow-2xl transition-all duration-1000 delay-200 ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
            } ${theme === "dark" ? "bg-white/5 border-white/10" : "bg-white/80 border-indigo-200"}`}
          >
            {/* Card Header */}
            <div
            ...
            >
              <div className="text-center">
                ...
                <h2 className={`text-3xl font-black mb-2 ${theme === "dark" ? "text-white" : "text-indigo-900"}`}>
            ...
            <div className="p-8">
              <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <Input
                      ...
                      className={`h-12 rounded-xl border-2 ${
                        theme === "dark"
                          ...
                          : "bg-gray-50 border-indigo-100 text-gray-600"
                      }`}
                    />
                  </div>
                ...
                <div className="space-y-6">
                  ...
                  <p className={`text-sm mb-4 ${theme === "dark" ? "text-gray-300" : "text-indigo-700"}`}>
                    Select your areas of interest to help us connect you with relevant opportunities
                  </p>
