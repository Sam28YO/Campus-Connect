...
const Home = () => {
  ...
  const [chatMessages, setChatMessages] = useState([
    {
      ...
      timestamp: new Date(),
      suggestions: ["Find Events", "Join Community", "Get Started", "Learn More"],
    },
  ])
  ...
  const memberDiscussions = [
    ...
    },
    {
      ...
      avatar: "AP",
      message: "Organizing a tech talk on blockchain next week. We have 50+ registrations already! Who's excited?",
      likes: 31,
      replies: 12,
      time: "4 hours ago",
      topic: "Tech Talk",
  ...
  const ambassadorBenefits = [
    {
      ...
      description: "Get official recognition as a Campus Ambassador with exclusive badges and certificates",
      gradient: "from-yellow-500 to-orange-500",
    },
    {
      icon: Network,
      title: "Exclusive Network",
      description: "Connect with ambassadors from top colleges and industry professionals",
      gradient: "from-blue-500 to-purple-500",
    },
    {
      icon: TrendingUp,
      title: "Career Opportunities",
      description: "Priority access to internships, job opportunities, and startup collaborations",
      gradient: "from-green-500 to-teal-500",
    },
    {
      icon: BookOpen,
      title: "Skill Development",
      description: "Free access to premium courses, workshops, and mentorship programs",
      gradient: "from-purple-500 to-pink-500",
    },
    {
      icon: DollarSign,
      title: "Monthly Stipend",
      description: "Earn ₹5,000-15,000 monthly based on your performance and activities",
      gradient: "from-emerald-500 to-green-500",
    },
    {
      icon: Plane,
      title: "Travel & Events",
      description: "Sponsored trips to conferences, hackathons, and exclusive ambassador meetups",
  ...
  const availableSkills = [
    ...
    "Digital Marketing", "Content Creation", "Event Management", "Public Speaking",
    "Leadership", "Community Building", "Social Media", "Photography", "Video Editing"
  ]

  // Chatbot responses
  const chatbotResponses = {
    "find events": {
      message: "Great! I can help you find events. What type of events are you interested in?",
      suggestions: ["Hackathons", "Workshops", "Tech Talks", "Competitions", "All Events"],
    },
    hackathons: {
      message:
    ...
    workshops: {
      ...
      suggestions: ["Join Workshop", "Get Notifications", "Browse All Workshops"],
    },
    "tech talks": {
      message:
    ...
    "join community": {
      ...
      suggestions: ["Create Profile", "Join Discussions", "Find Study Groups", "Connect with Peers"],
    },
    "get started": {
      message:
        "Let's get you started! Here's what you can do:\n\n1️⃣ Create your profile\n2️⃣ Explore events\n3️⃣ Join discussions\n4️⃣ Connect with students\n\nWhat would you like to do first?",
      suggestions: ["Create Profile", "Explore Events", "Join Discussions", "Learn More"],
    },
    "learn more": {
      message:
      ...
      suggestions: ["AI Matching", "Team Formation", "Event Discovery", "Community Features"],
    },
    default: {
      message:
  ...
  const successMetrics = [
    ...
    { icon: Calendar, value: "2K+", label: "Events Hosted", color: "text-green-400" },
    { icon: Award, value: "95%", label: "Success Rate", color: "text-yellow-400" },
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setCurrentDiscussionIndex((prev) => (prev === memberDiscussions.length - 1 ? 0 : prev + 1))
    }, 5000)
  ...
  const prevDiscussion = () => {
    setCurrentDiscussionIndex((prev) => (prev === 0 ? memberDiscussions.length - 1 : prev - 1))
  }
  ...
  const TestimonialCard = ({ testimonial, index }) => (
    ...
    >
      ...
      <blockquote
        className={`text-lg leading-relaxed mb-8 ${theme === "dark" ? "text-gray-300 group-hover:text-white" : "text-indigo-800 group-hover:text-indigo-900"}  `}
      >
        {`"${testimonial.review}"`}
      </blockquote>
  ...
  const EventCard = ({ event }) => (
    ...
    >
      <div className="flex items-center gap-3 mb-6">
        ...
        <span
          className={`font-bold px-3 py-1 rounded-full text-sm ${theme === "dark" ? "bg-purple-900/50 text-purple-300" : "bg-indigo-100 text-purple-700"}`}
        >
          {event.type}
        </span>
      </div>
      ...
      <button
        className={`w-full py-3 rounded-xl font-bold   transform hover:scale-105 ${theme === "dark" ? "bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white" : "bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white"}`}
      >
        View Details
      </button>
      <div
      ...
      >
        ...
        <p
          className={`text-center leading-relaxed   ${
            theme === "dark" ? "text-black group-hover:text-gray-200" : "text-indigo-700 group-hover:text-indigo-800"
          }`}
        >
          {step.description}
        </p>
  ...
  const DiscussionCard = ({ discussion }) => (
    ...
    >
      <div className="flex items-start gap-4 mb-4">
        <div
          className={`w-12 h-12 rounded-full flex items-center justify-center font-bold text-white ${theme === "dark" ? "bg-gradient-to-r from-purple-500 to-indigo-500" : "bg-gradient-to-r from-indigo-600 to-purple-600"} shadow-lg`}
        >
          {discussion.avatar}
        </div>
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-1">
            <h4 className={`font-bold ${theme === "dark" ? "text-white" : "text-indigo-900"}`}>{discussion.user}</h4>
            <span
              className={`px-2 py-1 rounded-full text-xs font-medium ${theme === "dark" ? "bg-purple-900/50 text-purple-300" : "bg-purple-100 text-purple-700"}`}
            >
              {discussion.topic}
            </span>
          </div>
      ...
      <p className={`mb-4 leading-relaxed ${theme === "dark" ? "text-gray-300" : "text-indigo-800"}`}>
        {discussion.message}
      </p>
      <div className="flex items-center gap-6">
        <button className="flex items-center gap-2 group">
          <Heart
            className={`w-5 h-5 ${theme === "dark" ? "text-gray-400 group-hover:text-red-400" : "text-gray-600 group-hover:text-red-500"} transition-colors duration-200`}
          />
          <span className={`text-sm font-medium ${theme === "dark" ? "text-gray-400" : "text-gray-600"}`}>
            {discussion.likes}
          </span>
        ...
        <button className="flex items-center gap-2 group">
          <MessageSquare
            className={`w-5 h-5 ${theme === "dark" ? "text-gray-400 group-hover:text-blue-400" : "text-gray-600 group-hover:text-blue-500"} transition-colors duration-200`}
          />
          <span className={`text-sm font-medium ${theme === "dark" ? "text-gray-400" : "text-gray-600"}`}>
            {discussion.replies}
          </span>
  ...
  // New FAQ Component
  const FAQSection = () => (
    <section className={`py-24 ${theme === "dark" ? "bg-white/5" : "bg-indigo-50/50"}`}>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className={`text-4xl md:text-5xl font-black mb-6 ${theme === "dark" ? "text-white" : "text-indigo-900"}`}>
            Frequently Asked{" "}
            <span
          ...
          <p className={`text-xl ${theme === "dark" ? "text-gray-300" : "text-indigo-700"}`}>
        ...
        <div className="space-y-6">
          {faqData.map((faq, index) => (
            <div
              key={index}
              className={`rounded-2xl border p-6   hover:shadow-lg ${theme === "dark" ? "bg-white/5 border-white/10 hover:bg-white/10" : "bg-white border-indigo-200 hover:bg-indigo-50"}`}
            >
              <div className="flex items-start gap-4">
                <HelpCircle
                  className={`w-6 h-6 mt-1 flex-shrink-0 ${theme === "dark" ? "text-yellow-400" : "text-indigo-600"}`}
                />
                <div>
                  <h3 className={`text-lg font-bold mb-3 ${theme === "dark" ? "text-white" : "text-indigo-900"}`}>
                    {faq.question}
                  </h3>
                  <p className={`leading-relaxed ${theme === "dark" ? "text-gray-300" : "text-indigo-700"}`}>
                    {faq.answer}
                  </p>
                </div>
              </div>
  ...
  const SuccessMetrics = () => (
    <section
      className={`py-16 ${theme === "dark" ? "bg-gradient-to-r from-slate-900 to-slate-800" : "bg-gradient-to-r from-indigo-100 to-purple-100"}`}
    >
          ...
          {successMetrics.map((metric, index) => {
            ...
            return (
              <div key={index} className="text-center">
                <div
                  className={`w-16 h-16 mx-auto mb-4 rounded-full flex items-center justify-center ${theme === "dark" ? "bg-white/10" : "bg-white/80"} backdrop-blur-xl`}
                >
                  <Icon className={`w-8 h-8 ${metric.color}`} />
                </div>
                <div className={`text-3xl font-black mb-2 ${theme === "dark" ? "text-white" : "text-indigo-900"}`}>
                  {metric.value}
                </div>
                <div className={`text-sm font-medium ${theme === "dark" ? "text-gray-300" : "text-indigo-700"}`}>
                  {metric.label}
                </div>
              </div>
            )
  ...
  const AmbassadorBenefitCard = ({ benefit }) => {
    ...
    return (
      ...
      >
        ...
        <h3
          className={`text-xl font-bold mb-3   ${theme === "dark" ? "text-white group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-purple-400 group-hover:to-yellow-300" : "text-indigo-900 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-indigo-600 group-hover:to-purple-600"}`}
        >
          {benefit.title}
        </h3>
        <p
          className={`text-sm leading-relaxed   ${theme === "dark" ? "text-gray-300 group-hover:text-gray-200" : "text-indigo-700 group-hover:text-indigo-800"}`}
        >
          {benefit.description}
        </p>
        <div
  ...
  return (
    ...
    >
      ...
      <button
        onClick={toggleTheme}
        className={`fixed top-6 right-6 z-50 p-3 rounded-full backdrop-blur-xl border   hover:scale-110 ${theme === "dark" ? "bg-white/10 border-white/20 text-yellow-300 hover:bg-white/20" : "bg-indigo-100 border-indigo-200 text-indigo-600 hover:bg-indigo-200"}`}
      >
      ...
      {showNewsletter && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center px-4">
          <div
            className={`rounded-3xl max-w-md w-full p-8 relative shadow-2xl ${theme === "dark" ? "bg-slate-800 text-white" : "bg-white text-indigo-900"}`}
          >
            <button
            ...
            <div className="text-center mb-6">
              <Mail className={`w-16 h-16 mx-auto mb-4 ${theme === "dark" ? "text-yellow-400" : "text-indigo-600"}`} />
      ...
      {showAmbassadorModal && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center px-4">
          <div
            className={`rounded-3xl max-w-2xl w-full max-h-[90vh] overflow-y-auto p-8 relative shadow-2xl ${theme === "dark" ? "bg-slate-800 text-white" : "bg-white text-indigo-900"}`}
          >
            <button
            ...
            <div className="text-center mb-8">
              <Crown className={`w-16 h-16 mx-auto mb-4 ${theme === "dark" ? "text-yellow-400" : "text-indigo-600"}`} />
              <h3 className="text-3xl font-black mb-2">Become a Campus Ambassador</h3>
              <p className={`${theme === "dark" ? "text-gray-300" : "text-indigo-700"}`}>
                Join our elite team of student leaders and make a difference on your campus
              </p>
            </div>
            ...
            <form onSubmit={handleAmbassadorSubmit} className="space-y-6">
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  <label className={`block text-sm font-bold mb-2 ${theme === "dark" ? "text-gray-300" : "text-indigo-700"}`}>
                    Full Name *
                  </label>
                  <input
                    type="text"
                    value={ambassadorForm.name}
                    onChange={(e) => handleAmbassadorFormChange('name', e.target.value)}
                    className={`w-full px-4 py-3 rounded-xl border-2   focus:outline-none focus:ring-4 ${
                      theme === "dark"
                        ? "bg-white/10 border-white/20 text-white placeholder-gray-400 focus:border-purple-400 focus:ring-purple-400/20"
                        : "bg-white border-indigo-200 text-indigo-900 placeholder-indigo-400 focus:border-indigo-500 focus:ring-indigo-500/20"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleAmbassadorFormChange('email', e.target.value)}
                    className={`w-full px-4 py-3 rounded-xl border-2   focus:outline-none focus:ring-4 ${
                      theme === "dark"
                        ? "bg-white/10 border-white/20 text-white placeholder-gray-400 focus:border-purple-400 focus:ring-purple-400/20"
                        : "bg-white border-indigo-200 text-indigo-900 placeholder-indigo-400 focus:border-indigo-500 focus:ring-indigo-500/20"
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleAmbassadorFormChange('phone', e.target.value)}
                    className={`w-full px-4 py-3 rounded-xl border-2   focus:outline-none focus:ring-4 ${
                      theme === "dark"
                        ? "bg-white/10 border-white/20 text-white placeholder-gray-400 focus:border-purple-400 focus:ring-purple-400/20"
                        : "bg-white border-indigo-200 text-indigo-900 placeholder-indigo-400 focus:border-indigo-500 focus:ring-indigo-500/20"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleAmbassadorFormChange('university', e.target.value)}
                    className={`w-full px-4 py-3 rounded-xl border-2   focus:outline-none focus:ring-4 ${
                      theme === "dark"
                        ? "bg-white/10 border-white/20 text-white placeholder-gray-400 focus:border-purple-400 focus:ring-purple-400/20"
                        : "bg-white border-indigo-200 text-indigo-900 placeholder-indigo-400 focus:border-indigo-500 focus:ring-indigo-500/20"
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleAmbassadorFormChange('course', e.target.value)}
                    className={`w-full px-4 py-3 rounded-xl border-2   focus:outline-none focus:ring-4 ${
                      theme === "dark"
                        ? "bg-white/10 border-white/20 text-white placeholder-gray-400 focus:border-purple-400 focus:ring-purple-400/20"
                        : "bg-white border-indigo-200 text-indigo-900 placeholder-indigo-400 focus:border-indigo-500 focus:ring-indigo-500/20"
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => handleAmbassadorFormChange('year', e.target.value)}
                    className={`w-full px-4 py-3 rounded-xl border-2   focus:outline-none focus:ring-4 ${
                      theme === "dark"
              ...
              <div>
                <label className={`block text-sm font-bold mb-3 ${theme === "dark" ? "text-gray-300" : "text-indigo-700"}`}>
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) => handleAmbassadorFormChange('experience', e.target.value)}
                  rows={4}
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) => handleAmbassadorFormChange('motivation', e.target.value)}
                  rows={4}
                  className={`w-full px-4 py-3 rounded-xl border-2   focus:outline-none focus:ring-4 resize-none ${
                    theme === "dark"
                      ? "bg-white/10 border-white/20 text-white placeholder-gray-400 focus:border-purple-400 focus:ring-purple-400/20"
              ...
              <div className={`p-4 rounded-xl border ${theme === "dark" ? "bg-white/5 border-white/10" : "bg-indigo-50 border-indigo-200"}`}>
                <h4 className={`font-bold mb-3 ${theme === "dark" ? "text-white" : "text-indigo-900"}`}>
              ...
              <div className="flex items-center gap-3">
                <input
                  ...
                  onChange={(e) => handleAmbassadorFormChange('agreeToTerms', e.target.checked)}
                  className="w-5 h-5 rounded"
                  required
                />
                <label htmlFor="agreeToTerms" className={`text-sm ${theme === "dark" ? "text-gray-300" : "text-indigo-700"}`}>
                  I agree to the terms and conditions and commit to fulfilling the ambassador responsibilities *
                </label>
              </div>
        ...
        {!isChatOpen ? (
          ...
          <div
            className={`w-96 h-[500px] rounded-3xl shadow-2xl border   ${
              theme === "dark" ? "bg-slate-800 border-white/20" : "bg-white border-indigo-200"
            } ${isMinimized ? "h-16" : "h-[500px]"}`}
          >
            {/* Chat Header */}
            <div
              className={`flex items-center justify-between p-4 border-b ${theme === "dark" ? "border-white/20" : "border-indigo-200"}`}
            >
              <div className="flex items-center gap-3">
                <div
                  className={`w-10 h-10 rounded-full flex items-center justify-center ${theme === "dark" ? "bg-gradient-to-r from-purple-500 to-indigo-500" : "bg-gradient-to-r from-indigo-600 to-purple-600"}`}
                >
                  <Bot className="w-6 h-6 text-white" />
                </div>
                <div>
                  <h3 className={`font-bold ${theme === "dark" ? "text-white" : "text-indigo-900"}`}>
                    Campus Assistant
                  </h3>
                  <p className={`text-xs ${theme === "dark" ? "text-green-400" : "text-green-600"}`}>● Online</p>
                </div>
              </div>
              <div className="flex items-center gap-2">
                <button
                  onClick={() => setIsMinimized(!isMinimized)}
                  className={`p-2 rounded-lg transition-colors ${theme === "dark" ? "hover:bg-white/10" : "hover:bg-indigo-100"}`}
                >
            ...
            {!isMinimized && (
              <>
                ...
                <div className="flex-1 p-4 h-80 overflow-y-auto space-y-4">
                  ...
                  {isTyping && (
                    <div className="flex justify-start">
                      <div className={`p-3 rounded-2xl ${theme === "dark" ? "bg-white/10" : "bg-indigo-50"}`}>
                        <div className="flex space-x-1">
                          <div
                            className={`w-2 h-2 rounded-full animate-bounce ${theme === "dark" ? "bg-white" : "bg-indigo-600"}`}
                ...
                {/* Chat Input */}
                <div className={`p-4 border-t ${theme === "dark" ? "border-white/20" : "border-indigo-200"}`}>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col lg:flex-row items-center gap-12">
              <div className="lg:w-1/2">
                ...
                >
                  <button
                    className={`group px-8 py-4 rounded-2xl font-bold   transform hover:scale-105 shadow-xl ${theme === "dark" ? "bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white" : "bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white"}`}
                  >
                  ...
                  <button
                    className={`group px-8 py-4 rounded-2xl font-bold border   transform hover:scale-105 ${theme === "dark" ? "border-white/20 hover:bg-white/10 text-white" : "border-indigo-200 hover:bg-indigo-50 text-indigo-700"}`}
                  >
                    Host Event
                  </button>
                  <Link href="/discussion">
                    <button
                      className={`group px-8 py-4 rounded-2xl font-bold border   transform hover:scale-105 ${theme === "dark" ? "border-purple-400/50 hover:bg-purple-400/10 text-purple-400" : "border-purple-200 hover:bg-purple-50 text-purple-700"}`}
                    >
                      <span className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className={`group px-8 py-4 rounded-2xl font-bold border   transform hover:scale-105 ${theme === "dark" ? "border-yellow-400/50 hover:bg-yellow-400/10 text-yellow-400" : "border-yellow-200 hover:bg-yellow-50 text-yellow-600"}`}
                  >
                    <span className="flex items-center gap-2">
          ...
          <div className="w-full overflow-hidden mt-6">
            <div className="flex animate-scroll-loop whitespace-nowrap">
              {[...studentActivities, ...studentActivities].map((activity, index) => (
                <div
                  key={index}
                  className={`min-w-max px-6 py-3 mx-2 rounded-2xl text-sm font-bold shadow-md ${theme === "dark" ? "bg-purple-900 text-purple-200" : "bg-indigo-100 text-indigo-800"}`}
                >
                  {activity}
                </div>
              ))}
...
<section
        ...
        {/* Search Bar Section */}
        <section className={`py-16 ${theme === "dark" ? "bg-white/5" : "bg-indigo-50/50"}`}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2
                className={`text-3xl md:text-4xl font-black mb-4 ${theme === "dark" ? "text-white" : "text-indigo-900"}`}
              >
                Discover{" "}
                <span
              ...
              <p className={`text-lg ${theme === "dark" ? "text-gray-300" : "text-indigo-700"}`}>
            ...
            <div className="max-w-2xl mx-auto mb-12">
              <div className="relative">
                <Search
                  className={`absolute left-4 top-1/2 transform -translate-y-1/2 w-6 h-6 ${theme === "dark" ? "text-gray-400" : "text-indigo-400"}`}
                />
                <input
                  type="text"
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <div className="flex items-center justify-center gap-3 mb-6">
                <MessageSquare className={`w-8 h-8 ${theme === "dark" ? "text-purple-400" : "text-indigo-600"}`} />
                <h2
                ...
                <Sparkles className={`w-8 h-8 ${theme === "dark" ? "text-yellow-400" : "text-purple-600"}`} />
              </div>
              <p className={`text-xl max-w-2xl mx-auto mb-6 ${theme === "dark" ? "text-gray-300" : "text-indigo-700"}`}>
                See what students are talking about, sharing, and collaborating on across campuses
              </p>
              <Link href="/discussion">
                <button
            ...
            <div className="relative">
              <div className="overflow-hidden rounded-3xl">
                <div
                  ...
                  style={{ transform: `translateX(-${currentDiscussionIndex * 100}%)` }}
                >
                  {memberDiscussions.map((discussion, index) => (
                    <div key={discussion.id} className="w-full flex-shrink-0 px-4">
              ...
              <button
                ...
                className={`absolute left-4 top-1/2 transform -translate-y-1/2 p-3 rounded-full backdrop-blur-xl border   hover:scale-110 ${theme === "dark" ? "bg-white/10 border-white/20 text-white hover:bg-white/20" : "bg-white/80 border-indigo-200 text-indigo-600 hover:bg-white"}`}
              >
              ...
              <button
                ...
                className={`absolute right-4 top-1/2 transform -translate-y-1/2 p-3 rounded-full backdrop-blur-xl border   hover:scale-110 ${theme === "dark" ? "bg-white/10 border-white/20 text-white hover:bg-white/20" : "bg-white/80 border-indigo-200 text-indigo-600 hover:bg-white"}`}
              >
        ...
        {showOffer && (
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-40 flex items-center justify-center px-4">
            ...
            >
              <button onClick={() => setShowOffer(false)} className="absolute top-3 right-3 text-xl font-bold">
                ✕
              </button>
                ...
                <div className="grid grid-cols-4 gap-3 mt-4">
                  {[
                    ...
                    >
                      ...
                      <div className="text-sm font-semibold uppercase tracking-wide opacity-80">{item.label}</div>
                    </div>
                  ))}
                </div>
                <div className="mt-6">
                  ...
                  <p className="text-xs mt-2 text-red-500 font-medium">⏳ Hurry! Only {seatsLeft} seats left</p>
                </div>
                <button
