...
import { CreditCard, User, Mail, DollarSign, CheckCircle, Loader2, AlertTriangle, Sun, Moon } from "lucide-react"
    ...
    return (
        <>
            ...
            <div className={`min-h-screen flex flex-col items-center justify-center ${theme === "dark"
                ...
                <div className={`max-w-md w-full rounded-3xl shadow-2xl border backdrop-blur-xl
        ...
        `}
                ...
                >
                    <div className="flex flex-col items-center mb-8">
                        ...
                        <p className={`text-lg text-center ${theme === "dark" ? "text-gray-300" : "text-indigo-700"
                            }`}>Complete your payment to unlock premium access</p>
                    </div>
                    {loading && (
