...
const slides = [
  {
    ...
    details:
      "The homepage gives an overview of recent campus activity, quick access to features, and promotes engagement right from the start.",
    image: "/home.jpg",
  },
  {
    ...
    details:
      "Threads, replies, and real-time conversations allow meaningful academic and social interaction in one place.",
  ...
  },
  {
    ...
    details:
      "Explore curated event feeds and RSVP with one click. Never miss what’s happening around you.",
    image: "/events.jpg",
  },
  {
    title: "Discover Page",
  ...
  },
  {
    ...
    details:
      "Showcase your campus journey, from events attended to clubs joined — all in one unified profile.",
    image: "/profile.jpg",
  },
];
